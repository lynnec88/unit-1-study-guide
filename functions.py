...
def repeat_string(string, num2):
    print(string * num2)
repeat_string("Hello, China! ",5)
...
def is_divisible_by_three(num):
    return num % 3 == 0
print(is_divisible_by_three(15))
print(is_divisible_by_three(10))
print(is_divisible_by_three(18))
...
write_letter("Lynne", "graphic designer", "Hackbright")
